"""Website Projects panel — browse files of website-marked projects."""
...
from src.utils.website_projects import load_website_projects
...
class WebsiteProjectsPanel(QWidget):
    """Panel showing file trees of website-marked projects."""
    ...
    def _setup_ui(self) -> None:
        ...
        left_header = QLabel("Website Projects")
    ...
    def refresh(self) -> None:
        """Reload the list of website projects from disk."""
        self._project_list.clear()
        websites = load_website_projects()
        for project_path in websites:
            p = Path(project_path)
        ...
        if not websites:
            ...
            self._preview.clear()
            self._preview_header.setText("No website projects — check projects in History tab")
            self._preview_header.setStyleSheet("padding: 4px; background-color: #2d2d2d; color: #666; font-size: 11px;")
